const createBuffer = require('gl-buffer') //creates buffers
const createVAO = require('gl-vao') //Vertex array object wrapper for WebGL http://stack.gl/gl-vao/

const pack = require('array-pack-2d') //Quickly pack a nested 2D array into a typed array – useful for flattening point data into a WebGL-friendly format.
const identity = require('gl-mat4/identity')
const clamp = require('clamp') //Clamp a value between two other values. It's as simple as modules come - saving keystrokes because I've had to write this function too many times.
